...
class SparseScaledDotProductAttention(nn.Module):
    def __init__(self, dropout: float = None, scale: bool = True, alpha: float = 1.5):
        super(SparseScaledDotProductAttention, self).__init__()
...
class SparseMultiHeadAttention(nn.Module):
    def __init__(self, n_head: int, d_model: int, dropout: float = 0.0, alpha: float = 1.5):
        ...
        self.attention = SparseScaledDotProductAttention(alpha=alpha)
